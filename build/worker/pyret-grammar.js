...
R(['fs', 'jglr/jglr'], function(fs, E) {
  ...
  g.addRule("prelude", [new Nonterm("provide-stmts"), new Nonterm("import-stmts")])
  g.addRule("provide-stmts", [new Nonterm("provide-stmts_I0*")])
  g.addRule("provide-stmts_I0*", [], E.Rule.Inline);
  g.addRule("provide-stmts_I0*", [new Nonterm("provide-stmts_I0*"), new Nonterm("provide-stmts_I0")], E.Rule.ListSnoc("provide-stmts_I0*", "provide-stmts_I0", true));
  g.addRule("provide-stmts_I0", [new Nonterm("provide-stmt")], E.Rule.Inline)
  g.addRule("import-stmts", [new Nonterm("import-stmts_I0*")])
  g.addRule("import-stmts_I0*", [], E.Rule.Inline);
  g.addRule("import-stmts_I0*", [new Nonterm("import-stmts_I0*"), new Nonterm("import-stmts_I0")], E.Rule.ListSnoc("import-stmts_I0*", "import-stmts_I0", true));
  g.addRule("import-stmts_I0", [new Nonterm("import-stmt")], E.Rule.Inline)
  ...
  out.write("  return runtime.makeModuleReturn({ PyretGrammar: Grammar.fromSerializable(g_json) }, {});\n");
  out.write("}\n");
  out.write("})\n");
  out.end();
});
